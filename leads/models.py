...
class ItemList(models.Model):
    name = models.CharField(max_length=50)
    sub_category = models.ForeignKey(SubCategory,default=0,on_delete=models.CASCADE)
...
class Lead(models.Model):
    ...
    category =  models.ForeignKey(Category, default=0, related_name='selected_category',on_delete=models.CASCADE)
    sub_category =  models.ForeignKey(SubCategory,default=0, related_name='selected_sub_category',on_delete=models.CASCADE)
    item_list =  models.ForeignKey(ItemList,default=0, related_name='selected_item',on_delete=models.CASCADE)
...
#     opted_products = models.ManyToManyField(Product,related_name='selected_products')
#
#     def __str__(self):
#         return self.name